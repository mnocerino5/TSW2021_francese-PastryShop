 <%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <%@ page contentType="text/html; charset=UTF-8" import="java.util.*,pastryshop.model.*"%>
 <%
...
$(document).ready(function(){
  $(".toogle-user").click(function(){
    $(".user-display").slideToggle("normal");
  });
});
</script>
<script>
